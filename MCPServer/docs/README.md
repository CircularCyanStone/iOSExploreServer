...
本目录包含 iOSExplore MCPServer 的测试报告、问题修复记录和最佳实践文档。
...
- **MCPServer**: `/Users/coo/Desktop/iOS_agent_debugger/iOSExploreServer/MCPServer/`
- **测试脚本**: `MCPServer/scripts/mcp-inspector.mjs`
