...
/// `ui.screenshot` 的命令参数（Foundation-only，macOS SPM 可测 wire 校验与 parse）。
///
/// 该类型刻意不 `import UIKit`，使输入定义与解析逻辑在 macOS 单元测试下可独立驱动，
...
public struct UIScreenshotInput: CommandInput, Sendable, Equatable {
    /// `ui.screenshot` 在 Swift 执行端使用的 generated 输入定义。
    public static let inputDefinition = UIKitActionContracts.uiScreenshotInput
    ...
    ///
    /// 缺省值由本方法在读取后填充（默认 1280），保证合同中的“可选字段”语义与实际
