...
/// `ui.scroll`、`ui.navigation.back`、`ui.wait`、`ui.scrollToElement`、`ui.alert.respond` 十二个命令显式挂到 router 上。
///
...
public extension ExploreServer {
    ...
    func registerUIKitCommands(maxResponseBodyBytes: Int = 6 * 1024 * 1024) {
        ...
        UIKitCommandLogging.info("uikit.registrar", "registration completed count=12")
    }
}
#endif
