...
public enum DiagnosticsActionContracts {
    ...
    static let appLogsReadInputSchema = CommandInputSchema(fields: [appLogsReadAfterField, appLogsReadLimitField.erased, appLogsReadMinimumLevelField.erased, appLogsReadSourcesField.erased], additionalProperties: false)
}