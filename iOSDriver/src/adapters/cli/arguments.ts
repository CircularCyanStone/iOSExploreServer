...
import type { CallCommandOptions, CLICommandName } from "./commands/commandTypes.js";
...
export interface MCPSetupArguments {
  ...
  /** 注册作用域（local/user/project）；省略时由注册层按客户端默认（codex=user，claude=local，trae=project）。 */
