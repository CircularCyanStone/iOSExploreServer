...
import { buildActionToolMap } from "./toolName.js";
export class ToolRegistry {
    ...
    async refresh() {
        try {
            ...
            this.dynamicTools = [];
            this.lastConflicts = [];
            const structured = error instanceof IOSExploreStructuredError
                ? error.toJSON()
                : { source: "mcp_server", code: "refresh_failed", message: error instanceof Error ? error.message : String(error) };
